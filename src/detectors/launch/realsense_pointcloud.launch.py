"""Launch the depth camera node and show the pointcloud in RVIZ
...
def generate_launch_description():
    ...
    rvizcfg = os.path.join(pkgdir('detectors'), 'rviz/viewpointcloud.rviz')
    ...
    rsargs = {'camera_name':             'camera',  # camera unique name
              'video_device':            '/dev/video0', # device for color stream
