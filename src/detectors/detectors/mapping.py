...
from detectors.config import WORLD_U, WORLD_V, ARUCO_CENTER_X, ARUCO_CENTER_Y
...
class DemoNode(Node):
    ...
    def process(self, msg):
        ...
        # Save image to png
        path = os.path.expanduser('~/robotws/src/detectors/table.png')
        ...
        xyCenter = self.pixelToWorld(image, u, v, x0, y0)
        
        # Mark the center of the image.
        cv2.circle(image, (uc, vc), 5, self.red, -1)
        cv2.circle(image, (u, v), 3, self.green, -1)
